...
import _Object$isFrozen from '@babel/runtime-corejs3/core-js-stable/object/is-frozen';
...
raf.setTimeout = function (handler, ms) {
  ...
  var cancel = function cancel() {
    var i = _findIndexInstanceProperty(timeouts).call(timeouts, function (t) {
      return t.cancel == cancel;
    });

    if (~i) _spliceInstanceProperty(timeouts).call(timeouts, i, 1);
    __raf.count -= ~i ? 1 : 0;
  };
  ...
  _spliceInstanceProperty(timeouts).call(timeouts, findTimeout(time), 0, timeout);
...
var findTimeout = function findTimeout(time) {
  return ~(~_findIndexInstanceProperty(timeouts).call(timeouts, function (t) {
    return t.time > time;
  }) || ~timeouts.length);
};
...
function update() {
  ...
  if (count) {
    eachSafely(_spliceInstanceProperty(timeouts).call(timeouts, 0, count), function (t) {
      return t.handler();
    });
    __raf.count -= count;
  }
...
(function (exports) {
  ...
  var globals = /*#__PURE__*/_Object$freeze({
    __proto__: null,
    ...
    sort: function sort(animation) {
      if (priority) {
        rafz.raf.onFrame(function () {
          return _sortInstanceProperty(frameLoop).call(frameLoop, animation);
        });
      } else {
        var prevIndex = currentFrame.indexOf(animation);

        if (~prevIndex) {
          _spliceInstanceProperty(currentFrame).call(currentFrame, prevIndex, 1);
  ...
  function startSafely(animation) {
    if (!_includesInstanceProperty(currentFrame).call(currentFrame, animation)) startUnsafely(animation);
  }

  function startUnsafely(animation) {
    _spliceInstanceProperty(currentFrame).call(currentFrame, findIndex(currentFrame, function (other) {
  ...
  function findIndex(arr, test) {
    var index = _findIndexInstanceProperty(arr).call(arr, test);
  ...
  function colorToRgba(input) {
    ...
    return _concatInstanceProperty(_context = _concatInstanceProperty(_context2 = _concatInstanceProperty(_context3 = "rgba(".concat(r, ", ")).call(_context3, g, ", ")).call(_context2, b, ", ")).call(_context, a, ")");
  }
  ...
  var createInterpolator = function createInterpolator(range, output, extrapolate) {
    ...
    return function (input) {
      ...
      return interpolate(input, inputRange[range], inputRange[range + 1], outputRange[range], outputRange[range + 1], easing, extrapolateLeft, extrapolateRight, _mapInstanceProperty(config));
    };
  };
  ...
  var $get = _Symbol$for('FluidValue.get');

  var $observers = _Symbol$for('FluidValue.observers');
  ...
  function addFluidObserver(target, observer) {
    if (target[$get]) {
      ...
      if (!observers) {
        setHidden(target, $observers, observers = new _Set());
      }
  ...
  var rgbaRound = function rgbaRound(_, p1, p2, p3, p4) {
    ...
    return _concatInstanceProperty(_context4 = _concatInstanceProperty(_context5 = _concatInstanceProperty(_context6 = "rgba(".concat(Math.round(p1), ", ")).call(_context6, Math.round(p2), ", ")).call(_context5, Math.round(p3), ", ")).call(_context4, p4, ")");
  };

  var createStringInterpolator = function createStringInterpolator(config) {
    var _context7, _context9;

    if (!namedColorRegex) namedColorRegex = colors$1 ? new RegExp("(".concat(_Object$keys(colors$1).join('|'), ")(?!\\w)"), 'g') : /^\b$/;

    var output = _mapInstanceProperty(_context7 = config.output).call(_context7, function (value) {
      return getFluidValue(value).replace(colorRegex, colorToRgba).replace(namedColorRegex, colorToRgba);
    });

    var keyframes = _mapInstanceProperty(output).call(output, function (value) {
      var _context8;

      return _mapInstanceProperty(_context8 = value.match(numberRegex)).call(_context8, Number);
    });

    var outputRanges = _mapInstanceProperty(_context9 = keyframes[0]).call(_context9, function (_, i) {
      return _mapInstanceProperty(keyframes).call(keyframes, function (values) {
        if (!(i in values)) {
    ...
    var interpolators = _mapInstanceProperty(outputRanges).call(outputRanges, function (output) {
    ...
    return function (input) {
      ...
      var missingUnit = !unitRegex.test(output[0]) && ((_output$find = _findInstanceProperty(output).call(output, function (value) {
      ...
      return output[0].replace(numberRegex, function () {
        ...
        return _concatInstanceProperty(_context10 = "".concat(interpolators[i++](input))).call(_context10, missingUnit || '');
...
var $node = _Symbol$for('Animated:node');
...
var AnimatedArray = /*#__PURE__*/function (_AnimatedObject) {
  ...
  _createClass(AnimatedArray, [{
    ...
    value: function getValue() {
      ...
      return _mapInstanceProperty(_context = this.source).call(_context, function (node) {
    ...
    value: function setValue(source) {
      ...
      if (source.length == payload.length) {
        return _mapInstanceProperty(payload).call(payload, function (node, i) {
          return node.setValue(source[i]);
        }).some(Boolean);
      }

      _get(_getPrototypeOf(AnimatedArray.prototype), "setValue", this).call(this, _mapInstanceProperty(source).call(source, makeAnimated));
...
var cacheKey = _Symbol$for('AnimatedComponent');
...
(function (exports) {
  ...
  var matchProp = function matchProp(value, key) {
    ...
    return value === true || !!(key && value && (shared.is.fun(value) ? value(key) : _includesInstanceProperty(_context = shared.toArray(value)).call(_context, key)));
  };
  ...
  function computeGoal(value) {
    ...
    return shared.is.arr(value) ? _mapInstanceProperty(value).call(value, computeGoal) : shared.isAnimatedString(value) ? shared.Globals.createStringInterpolator({
      range: [0, 1],
      output: [value, value]
    })(1) : value;
  }
    ...
    shared.useLayoutEffect(function () {
      if (timeSteps) {
        ...
        shared.each(refs, function (ref) {
          ...
          if (controllers.length) {
            var queues = _mapInstanceProperty(controllers).call(controllers, function (ctrl) {
              var q = ctrl.queue;
              ctrl.queue = [];
              return q;
            });
  ...
  function mergeConfig(config, newConfig, defaultConfig) {
    ...
    _Object$assign(config, newConfig);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              bailPromise = new _Promise(function (resolve, reject) {
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        ...
                        case 11:
                          ...
                          _context2.next = 16;
                          return new _Promise(function (resume) {
            ...
            case 9:
              ...
              if (shared.is.arr(to)) {
                ...
                animating = _Promise.resolve(to(animate, target.stop.bind(target)));
              }

              _context4.next = 13;
              return _Promise.all([animating.then(preventBail), bailPromise]);
  ...
  var FrameValue = /*#__PURE__*/function (_shared$FluidValue) {
    _inherits(FrameValue, _shared$FluidValue);
    ...
    _createClass(FrameValue, [{
      ...
      value: function _onPriorityChange(priority) {
        if (!this.idle) {
          ...
          _sortInstanceProperty(_context6 = shared.frameLoop).call(_context6, this);
        }
  ...
  var SpringValue = /*#__PURE__*/function (_FrameValue) {
    ...
    function SpringValue(arg1, arg2) {
      ...
      _this4._state = {
        paused: false,
        pauseQueue: new _Set(),
        resumeQueue: new _Set(),
        timeouts: new _Set()
      };
      _this4._pendingCalls = new _Set();
    ...
    _createClass(SpringValue, [{
      ...
      get: function get() {
        ...
        var node = animated$1.getAnimated(this);
        return node instanceof animated$1.AnimatedValue ? node.lastVelocity || 0 : _mapInstanceProperty(_context7 = node.getPayload()).call(_context7, function (node) {
      ...
      value: function advance(dt) {
        ...
        _valuesInstanceProperty(anim).forEach(function (node, i) {
          if (node.done) return;
      ...
      value: function start(to, arg2) {
        ...
        return _Promise.all(_mapInstanceProperty(queue).call(queue, function (props) {
      ...
      value: function _prepareNode(props) {
        ...
        if (!hasAnimated(this)) {
          if (_reverseInstanceProperty(props)) {
            var _ref6 = [from, to];
            to = _ref6[0];
            from = _ref6[1];
          }
      ...
      value: function _update(_ref, isLoop) {
        ...
        if (props.default) _Object$assign(defaultProps, getDefaultProps(props, function (value, prop) {
      ...
      value: function _merge(range, props, resolve) {
        ...
        if (hasToChanged) {
          ...
          if (nodeType !== node.constructor) {
            ...
            if (immediate) {
              node = this._set(goal);
            } else throw Error(_concatInstanceProperty(_context8 = "Cannot animate between ".concat(node.constructor.name, " and ")).call(_context8, nodeType.name, ", as the \"to\" prop suggests"));
          }
        }
      ...
      value: function _start() {
        ...
        if (!anim.immediate) {
          ...
          anim.fromValues = _mapInstanceProperty(_context9 = _valuesInstanceProperty(anim)).call(_context9, function (node) {
      ...
      value: function _stop(goal, cancel) {
        if (isAnimating(this)) {
          ...
          var anim = this.animation;
          shared.each(_valuesInstanceProperty(anim), function (node) {
            node.done = true;
          });
  ...
  function createLoopUpdate(props) {
    ...
    if (loopRet) {
      ...
      var reverse = _reverseInstanceProperty(overrides || props);
  ...
  function createUpdate(props) {
    ...
    props.keys = keys.size ? _Array$from(keys) : null;
    return props;
  }
  ...
  function sendEvent(target, type) {
    ...
    (_target$animation$typ = (_target$animation = target.animation)[type]) == null ? void 0 : (_target$animation$typ2 = _target$animation$typ).call.apply(_target$animation$typ2, _concatInstanceProperty(_context10 = [_target$animation]).call(_context10, args));
    (_target$defaultProps$ = (_target$defaultProps = target.defaultProps)[type]) == null ? void 0 : (_target$defaultProps$2 = _target$defaultProps$).call.apply(_target$defaultProps$2, _concatInstanceProperty(_context11 = [_target$defaultProps]).call(_context11, args));
  }
  ...
  var Controller = /*#__PURE__*/function () {
    function Controller(props, flush) {
      ...
      this._lastAsyncId = 0;
      this._active = new _Set();
      this._changed = new _Set();
      this._started = false;
      this._item = void 0;
      this._state = {
        paused: false,
    ...
    _createClass(Controller, [{
      key: "idle",
      get: function get() {
        return !this._state.asyncTo && _Object$values(this.springs).every(function (spring) {
          return spring.idle;
        });
      }
    }, {
      ...
      value: function start(props) {
        ...
        if (props) {
          ...
          queue = _mapInstanceProperty(_context12 = shared.toArray(props)).call(_context12, createUpdate);
        } else {
          this.queue = [];
        }
      ...
      return _regeneratorRuntime.wrap(function _callee4$(_context17) {
        while (1) {
          switch (_context17.prev = _context17.next) {
            case 0:
              keys = _keysInstanceProperty(props), to = props.to, from = props.from, loop = props.loop, onRest = props.onRest, onResolve = props.onResolve;
              ...
              promises = _mapInstanceProperty(_context16 = keys || _Object$keys(ctrl.springs)).call(_context16, function (key) {
  ...
  function getSprings(ctrl, props) {
    ...
    if (props) {
      shared.each(shared.toArray(props), function (props) {
        if (shared.is.und(_keysInstanceProperty(props))) {
  ...
  function prepareSprings(springs, props, create) {
    if (_keysInstanceProperty(props)) {
      shared.each(_keysInstanceProperty(props), function (key) {
  ...
  function makeContext(target, init) {
    _Object$assign(target, React__namespace.createContext(init));
  ...
  var SpringRef = function SpringRef() {
    ...
    SpringRef.add = function (ctrl) {
      if (!_includesInstanceProperty(current).call(current, ctrl)) {
        current.push(ctrl);
      }
    };
    ...
    SpringRef.delete = function (ctrl) {
      ...
      if (~i) _spliceInstanceProperty(current).call(current, i, 1);
    };
  ...
  function useSprings(length, props, deps) {
    ...
    var state = React.useMemo(function () {
      return {
        ...
        flush: function flush(ctrl, updates) {
          ...
          var canFlushSync = layoutId.current > 0 && !state.queue.length && !_Object$keys(springs).some(function (key) {
            return !ctrl.springs[key];
          });
          return canFlushSync ? flushUpdateQueue(ctrl, updates) : new _Promise(function (resolve) {
            setSprings(ctrl, springs);
    ...
    React.useMemo(function () {
      ...
      shared.each(_sliceInstanceProperty(_context13 = ctrls.current).call(_context13, length, prevLength), function (ctrl) {
        detachRefs(ctrl, ref);
        ctrl.stop(true);
      });
    ...
    var springs = _mapInstanceProperty(_context14 = ctrls.current).call(_context14, function (ctrl, i) {
    ...
    var values = _mapInstanceProperty(springs).call(springs, function (x) {
      return _extends({}, x);
    });
  ...
  function useTrail(length, propsArg, deps) {
    ...
    var result = useSprings(length, function (i, ctrl) {
      ...
      reverse = reverse && _reverseInstanceProperty(props);
      return props;
    }, deps || [{}]);
    var ref = result[1];
    shared.useLayoutEffect(function () {
    ...
    if (propsFn || arguments.length == 3) {
      ref['_getProps'] = function (propsArg, ctrl, i) {
        ...
        if (props) {
          var parent = ref.current[i + (_reverseInstanceProperty(props) ? 1 : -1)];
  ...
  function useTransition(data, props, deps) {
    ...
    var _ref14 = propsFn ? propsFn() : props,
        reset = _ref14.reset,
        sort = _sortInstanceProperty(_ref14),
    ...
    if (reused.length) {
      ...
      shared.each(reused, function (keyIndex, prevIndex) {
        ...
        if (~keyIndex) {
          ...
          _spliceInstanceProperty(transitions).call(transitions, ++i, 0, t);
        }
      });
    }

    if (shared.is.fun(sort)) {
      _sortInstanceProperty(transitions).call(transitions, function (a, b) {
    ...
    shared.each(transitions, function (t, i) {
      ...
      payload.onResolve = function (result) {
        ...
        var t = _findInstanceProperty(transitions).call(transitions, function (t) {
          return t.key === key;
        });
    ...
    var renderTransitions = function renderTransitions(render) {
      return React__namespace.createElement(React__namespace.Fragment, null, _mapInstanceProperty(transitions).call(transitions, function (t, i) {
  ...
  function getKeys(items, _ref19, prevTransitions) {
    var key = _ref19.key,
        _ref19$keys = _keysInstanceProperty(_ref19),
        keys = _ref19$keys === void 0 ? key : _ref19$keys;

    if (keys === null) {
      var reused = new _Set();
      return _mapInstanceProperty(items).call(items, function (item) {
        var t = prevTransitions && _findInstanceProperty(prevTransitions).call(prevTransitions, function (t) {
    ...
    return shared.is.und(keys) ? items : shared.is.fun(keys) ? _mapInstanceProperty(items).call(items, keys) : shared.toArray(keys);
  }
  ...
  var Interpolation = /*#__PURE__*/function (_FrameValue2) {
    ...
    function Interpolation(source, args) {
      ...
      _this16.idle = true;
      _this16.calc = void 0;
      _this16._active = new _Set();
      _this16.source = source;
      _this16.calc = shared.createInterpolator.apply(shared, _toConsumableArray(args));

      var value = _this16._get();

      var nodeType = animated$1.getAnimatedType(value);
      animated$1.setAnimated(_assertThisInitialized(_this16), nodeType.create(value));
      return _this16;
    }
    ...
    _createClass(Interpolation, [{
      ...
      value: function _get() {
        ...
        var inputs = shared.is.arr(this.source) ? _mapInstanceProperty(_context15 = this.source).call(_context15, shared.getFluidValue) : shared.toArray(shared.getFluidValue(this.source));
  ...
  function checkIdle(active) {
    return !active.size || _Array$from(active).every(isIdle);
  }
  ...
  _Object$keys(animated).forEach(function (k) {
  ...
  _Object$keys(interpolation).forEach(function (k) {
    if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
      enumerable: true,
      get: function get() {
...
(function (exports) {
  ...
  function dangerousStyleValue(name, value) {
    ...
    return _trimInstanceProperty(_context = '' + value).call(_context);
  }
  ...
  function applyAnimatedValues(instance, props) {
    ...
    var values = _Object$values(attributes);

    var names = _mapInstanceProperty(_context2 = _Object$keys(attributes)).call(_context2, function (name) {
  ...
  isUnitlessNumber = _Object$keys(isUnitlessNumber).reduce(function (acc, prop) {
  ...
  var AnimatedStyle = /*#__PURE__*/function (_animated$1$AnimatedO) {
    _inherits(AnimatedStyle, _animated$1$AnimatedO);
    ...
    function AnimatedStyle(_ref) {
      ...
      if (x || y || z) {
        ...
        transforms.push(function (xyz) {
          return ["translate3d(".concat(_mapInstanceProperty(xyz).call(xyz, function (v) {
            return addUnit(v, 'px');
      ...
      shared.eachProp(style, function (value, key) {
        if (key === 'transform') {
          ...
          transforms.push(key === 'rotate3d' ? function (_ref2) {
            ...
            return [_concatInstanceProperty(_context3 = _concatInstanceProperty(_context4 = _concatInstanceProperty(_context5 = "rotate3d(".concat(x, ",")).call(_context5, y, ",")).call(_context4, z, ",")).call(_context3, addUnit(deg, unit), ")"), isValueIdentity(deg, 0)];
          } : function (input) {
            var _context6;

            return [_concatInstanceProperty(_context6 = "".concat(key, "(")).call(_context6, _mapInstanceProperty(input).call(input, function (v) {
              return addUnit(v, unit);
            }).join(','), ")"), isValueIdentity(input, _startsWithInstanceProperty(key).call(key, 'scale') ? 1 : 0)];
          });
        }
      });
  ...
  var FluidTransform = /*#__PURE__*/function (_shared$FluidValue) {
    _inherits(FluidTransform, _shared$FluidValue);
    ...
    _createClass(FluidTransform, [{
      ...
      value: function _get() {
        ...
        shared.each(this.inputs, function (input, i) {
          ...
          var _this2$transforms$i = _this2.transforms[i](shared.is.arr(arg1) ? arg1 : _mapInstanceProperty(input).call(input, shared.getFluidValue)),
  ...
  _Object$keys(core).forEach(function (k) {
    if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
      enumerable: true,
      get: function get() {
        return core[k];
...
var animated$1 = reactSpringWeb_cjs_prod.animated;
var useSpring = reactSpringWeb_cjs_prod.useSpring;
export { animated$1 as animated, useSpring };
